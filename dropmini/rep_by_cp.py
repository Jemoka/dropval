...
dat.sort_values(by="checkpoint")[(dat.model=="dropout") & (dat.layer==1)].to_csv("./output/dropmini_dropout_l1_checkpoints.dat", sep=" ", index=False)
dat.sort_values(by="checkpoint")[(dat.model=="no_dropout") & (dat.layer==1)].to_csv("./output/dropmini_no_dropout_l1_checkpoints.dat", sep=" ", index=False)

dat.sort_values(by="checkpoint")[(dat.model=="dropout") & (dat.layer==2)].to_csv("./output/dropmini_dropout_l2_checkpoints.dat", sep=" ", index=False)
dat.sort_values(by="checkpoint")[(dat.model=="no_dropout") & (dat.layer==2)].to_csv("./output/dropmini_no_dropout_l2_checkpoints.dat", sep=" ", index=False)
